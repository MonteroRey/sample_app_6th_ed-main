Rails.application.configure do
  ...
  # Don't care if the mailer can't send.rub
  ...
  config.action_mailer.smtp_settings = {address: 'smtp.gmail.com',port:587,user_name: 'rey.montero@kodakollectiv.com',password: 'vbytwzbmdecktsvz'} 
